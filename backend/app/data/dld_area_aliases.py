...
MARKETING_TO_CADASTRAL_PRIMARY: dict[str, str] = {
    ...
    # --- Category A hidden gems (round 2) from docs/area-identity-map.csv:
    # community → cadastral home, each validated to hold the full triad. ---
    "dubai world central": "madinat al mataar",
    "dwc": "madinat al mataar",
    "dmcc master community": "al thanyah fifth",
    "jumeirah garden city": "al satwa",
    "meydan racecourse community": "nad al shiba first",
    "meydan racecourse": "nad al shiba first",
    "festival city": "al kheeran",
    "dubai festival city": "al kheeran",
    "la mer": "jumeirah first",
    "emirates living": "al thanayah fourth",
    "international media production zone": "me'aisem first",
    "international city phase 3": "warsan fourth",
    "international city ph 3": "warsan fourth",
    "dubai healthcare city": "um hurair second",
    "dubai health care city phase 1": "um hurair second",
    "dubai health care city phase 2": "al jadaf",
    "arabian ranches ii": "wadi al safa 7",
    "liwan": "wadi al safa 2",
    "liwan1": "wadi al safa 2",
    "uptown mirdif": "mirdif",
    "al khail towers": "al goze fourth",
    "badra": "hessyan first",
    "jumeira bay": "island 2",
    "madinat badr": "muhaisanah first",
    "riggat al buteen": "rega al buteen",
    "umm suqeim third": "um suqaim third",
    "nadd al hamar": "nad al hamar",
    "wasl 1": "al kifaf",
    "site a": "al safouh second",
    # registry-spelling variants of the above (2026-snapshot names not in canonical):
    "emirate living": "al thanayah fourth",
    "meydan one": "al merkadh",
    "meydan one community": "al merkadh",
    "sobha heartland": "al merkadh",
    "international city ph 2 & 3": "warsan fourth",
    "international city phase 2 & 3": "warsan fourth",
}
